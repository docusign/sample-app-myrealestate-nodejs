...
const loginInfo = (props) => (
    <div className={classes.Form}>
        ...
        <ul>
            ...
            <li>{textContent.login.info.listItem3Part1} <a href='https://developers.docusign.com/rooms-api/reference/Offices' target='_blank' rel="noopener noreferrer">{textContent.login.info.listItem3Part2}</a></li>
        </ul>
        ...
        <div className={classes.CodeFlow}>
            ...
            <p>{textContent.login.info.step2info1} <a href="https://developers.docusign.com/rooms-api/reference/Users/Users/GetUsers" target="_blank" rel="noopener noreferrer">{textContent.login.info.step2info2}</a></p>
            <h3>{textContent.login.info.step3}</h3>
            <p>{textContent.login.info.step3info1} <a href='https://developers.docusign.com/rooms-api/reference/Offices/Offices/CreateOffice' target='_blank' rel="noopener noreferrer">{textContent.login.info.step3info2}</a> {textContent.login.info.step3info3} <a href='https://developers.docusign.com/rooms-api/reference/Users/Users/AddUserToOffice' target='_blank' rel="noopener noreferrer">{textContent.login.info.step3info4}</a>{textContent.login.info.step3info5}</p>
        </div>
    </div>
);

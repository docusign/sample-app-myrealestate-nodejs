...
const roomsInfo = (props) => {
    ...
    return (
        <div className={classes.Form}>
            ...
            <p>{info.GithubSource1} <a href="https://github.com/docusign/sample-app-realestate-nodejs/blob/main/controllers/roomsController.js#L23" target="_blank" rel="noopener noreferrer">{info.GithubSource2}</a> {info.GithubSource3} <a href="https://github.com/docusign/sample-app-realestate-nodejs/blob/main/controllers/roomsController.js#L180" target="_blank" rel="noopener noreferrer">{info.GithubSource4}</a> {info.GithubSource5}</p>
            <p>{info.paragraph1}</p>
            <ul>
